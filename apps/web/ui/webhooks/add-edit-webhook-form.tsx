  ...
  return (
    <>
      ...
      >
        ...
        <div className="rounded-md border border-gray-200 p-4">
          <label htmlFor="triggers" className="flex flex-col gap-1">
            <h2 className="text-sm font-medium text-gray-900">{t('link-level-events-high-traffic', { "component0": <span className="rounded bg-yellow-100 px-1 py-0.5 text-xs font-medium text-yellow-800">{t('link-level-events-high-traffic_component0')}</span> })}
