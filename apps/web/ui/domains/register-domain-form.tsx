                ...
                <div className="flex justify-between gap-3 px-2 pb-2 pt-3 text-sm text-gray-700">
                  <p>
                    {searchedDomain ? (
                      searchedDomain.available ? (
                        <>
                          {t('searched-domain-available-message', { "component0": {t('searched-domain-available-message_component0', { "_searchedDomain_domain_": _searchedDomain_domain_ })} })}</>
                      ) : (
                        <>
                          {t('searched-domain-available-prefix', { "component0": {t('searched-domain-available-prefix_component0', { "_searchedDomain_domain_": _searchedDomain_domain_ })} })}
                      ...
                      <>{t('checking-availability-message', { "component0": {t('checking-availability-message_component0', { "_truncate_slug_link_25_": _truncate_slug_link_25_ })} })}
