                  ...
                  <p>
                    {searchedDomain ? (
                      searchedDomain.available ? (
                        ...
                        <>
                          {t('domain-is', { "component0": {t('domain-is_component0', { "_searchedDomain_domain_": _searchedDomain_domain_ })} })}
                      ...
                      <>{t('checking-availability-for', { "component0": {t('checking-availability-for_component0', { "_truncate_slug_link_25_": _truncate_slug_link_25_ })} })}
...
const t = useTranslations("../ui/domains");
  ...
  return (
    <div className="flex items-center gap-1.5 rounded-lg bg-white p-4 text-sm shadow-[0_4px_12px_#0000001a]">
      ...
      <p className="text-[13px] font-medium text-gray-900">{t('domain-saved-pro-plan', { "component0": <a
          href="https://dub.co/help/article/free-dot-link-domain"
          target="_blank"
          className="text-gray-500 underline transition-colors hover:text-gray-800"
        >{t('domain-saved-pro-plan_component0')}</a> })}
