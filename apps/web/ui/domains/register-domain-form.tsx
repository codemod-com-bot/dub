          ...
          <div className="mt-2">
            ...
            >
              <div className="flex rounded-md border border-gray-300 bg-white">
                ...
                />
                <span className="inline-flex items-center rounded-md rounded-l-none bg-white pr-3 font-medium text-gray-500 sm:text-sm">{t('link-extension')}</span>
              </div>
                ...
                <div className="flex justify-between gap-3 px-2 pb-2 pt-3 text-sm text-gray-700">
                  <p>
                    {searchedDomain ? (
                      searchedDomain.available ? (
                        <><Trans
i18nKey="domain-available-claim"
values={{ _searchedDomain_domain_: <>
...
/>
                      ...
                      <><Trans
i18nKey="checking-availability-for"
values={{ _truncate_slug_link_25_: <>
...
/>
        ...
        {searchedDomain && (
          <p className="-my-2 text-pretty text-left text-sm text-gray-400"><Trans
...
const { t } = useTranslation("../ui/domains");
  ...
  return (
    <div className="flex items-center gap-1.5 rounded-lg bg-white p-4 text-sm shadow-[0_4px_12px_#0000001a]">
      ...
      <p className="text-[13px] font-medium text-gray-900"><Trans
i18nKey="domain-saved-pro-plan"
components={{"0": 
        <a
          href="https://dub.co/help/article/free-dot-link-domain"
          target="_blank"
