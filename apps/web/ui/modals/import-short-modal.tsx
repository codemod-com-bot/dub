    ...
    >
      <div className="flex flex-col items-center justify-center space-y-3 border-b border-neutral-200 px-4 py-8 sm:px-16">
        ...
        <h3 className="text-lg font-medium">
          {t("import-your-short-io-links")}
        </h3>
        <p className="text-center text-sm text-neutral-500">
          {t("import-existing-short-io-links-description", {
            ...
            <div>
              <div className="flex items-center space-x-2">
                <h2 className="text-sm font-medium text-neutral-900">
                  {t("short-io-api-key-label")}
                </h2>
                <InfoTooltip
                  content={
                    <SimpleTooltipContent
                      title={t("short-io-api-key-description")}
                      cta="Read the guide."
