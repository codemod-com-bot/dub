  ...
  return (
    ...
    >
      <div className="flex flex-col items-center justify-center space-y-3 border-b border-gray-200 px-4 py-4 pt-8 text-center sm:px-16">
        ...
        <h3 className="text-lg font-medium">{t('set-as-primary-domain', { "domain": domain })}</h3>
        <p className="text-sm text-gray-500">{t('setting-domain-as-primary-description', { "component0": <a
          ...
          >{t('setting-domain-as-primary-description_component0')}</a> })}
      ...
      <div className="flex flex-col space-y-6 bg-gray-50 px-4 py-8 text-left sm:px-16">
        <Button
          ...
          autoFocus
          loading={loading}
          text={t('set-as-primary-domain-short')}
        />
      </div>
    </Modal>
  );
