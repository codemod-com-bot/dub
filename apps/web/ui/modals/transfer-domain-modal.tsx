    ...
    >
      ...
      >
        <div className="flex flex-col items-center justify-center space-y-3 border-b border-gray-200 px-4 py-4 pt-8 text-center sm:px-16">
          ...
          <h3 className="text-lg font-medium">{t('transfer-{domain}', { domain })}</h3>
          <p className="text-sm text-gray-500">{t('transfer-this-domain-and-its-links-to-another-{app-name}-workspace-link-tags-will-not-be-transferred', { APP_NAME })}</p>
        </div>
