      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <InfoTooltip
            content={
              <SimpleTooltipContent
                title={t("custom-link-preview-description")}
                cta="Learn more."
        ...
        <Switch
          ...
          disabledTooltip={
            !url ? (
              ...
              <TooltipContent
                title={t("custom-link-previews-pro-plan")}
                cta="Upgrade to Pro"
                href={
                  slug
    ...
    if (image) {
      return (
        <FileUpload
          ...
          accessibilityLabel={t("og-image-upload")}
        />
      );
    } else {
      return (
        <div className="relative aspect-[var(--aspect,1200/630)] w-full bg-white">
          <div className="absolute inset-0 opacity-0">
            <FileUpload
              ...
              clickToUpload={false}
              showHoverOverlay={false}
              accessibilityLabel={t("og-image-upload-duplicate")}
            />
          </div>
          {!isMobile && (
