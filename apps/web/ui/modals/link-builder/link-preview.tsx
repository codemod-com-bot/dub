      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <ProBadgeTooltip
            content={
              <SimpleTooltipContent
                title={t('customize-link-appearance')}
                cta="Learn more."
      ...
      return (
        <div className="relative aspect-[var(--aspect,1200/630)] w-full bg-white">
          ...
          <div className="pointer-events-none relative flex size-full flex-col items-center justify-center gap-2">
            ...
            <p className="max-w-32 text-center text-xs text-gray-700">{t('enter-link-to-generate-preview')}</p>
          </div>
        </div>
      );
    }
...
const t = useTranslations("../ui/modals/link-builder");
  ...
  return (
    <div>
      ...
      {hostname && (
        <p className="mt-1 text-xs text-[#606770]">{t('from-hostname', { "hostname": hostname })}</p>
      )}
    </div>
  );
}
