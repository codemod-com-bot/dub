      ...
      if (error.message.includes("Upgrade to Pro")) {
        toast.custom(() => (
          <UpgradeRequiredToast
            title={t("youve-exceeded-your-ai-usage-limit")}
  ...
  const {
    ...
    onError: (error) => {
      if (error.message.includes("Upgrade to Pro")) {
        toast.custom(() => (
          <UpgradeRequiredToast
            title={t("youve-exceeded-your-ai-usage-limit-duplicate")}
            message={error.message}
          />
        ));
      } else {
              ...
              <Tooltip
                content={
                  <div className="px-2 py-1 text-xs text-gray-700">
                    {t("press-l-to-open-quickly", {
                      component0: (
                        <strong className="font-medium text-gray-950">
                          {t("press-l-to-open-quickly_component0")}
                        </strong>
                      ),
                    })}
                  </div>
              ...
              <FileUpload
                ...
                content={
                  <>
                    ...
                    <p className="mt-1">{t("recommended-1200x630-pixels")}</p>
                  </>
                }
              />
            </div>
