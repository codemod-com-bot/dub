...
i18nKey="press-a-to-open-quickly"
components={{"0": <strong className="font-medium text-gray-950" />}}
/></div>
              }
              side="right"
            >
              <kbd className="flex size-6 cursor-default items-center justify-center gap-1 rounded-md border border-gray-200 font-sans text-xs text-gray-950">{t('a-key')}</kbd>
            </Tooltip>
          </div>
        </div>
