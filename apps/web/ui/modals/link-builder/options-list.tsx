      ...
      content={
        ...
        >
          {data.iframeable ? (
            ...
            <span>
              {t(
                "we-will-try-to-cloak-it-with-nextjs-rewrites-but-it-might-not-work-as-expected-learn-more",
                {
                  component0: (
                    <a
                    ...
                    >
                      {t(
                        "we-will-try-to-cloak-it-with-nextjs-rewrites-but-it-might-not-work-as-expected-learn-more_component0",
                      )}
                    </a>
                  ),
                  component1: (
                    ...
                    >
                      {t(
                        "we-will-try-to-cloak-it-with-nextjs-rewrites-but-it-might-not-work-as-expected-learn-more_component1",
                      )}
                    </a>
                  ),
                },
