      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <ProBadgeTooltip
            content={
              <SimpleTooltipContent
                title={t('restrict-access-to-short-links')}
                cta="Learn more."
...
i18nKey="press-p-to-open-quickly"
components={{"0": <strong className="font-medium text-gray-950" />}}
/></div>
            }
            side="right"
          >
            <kbd className="flex size-6 cursor-default items-center justify-center rounded-md border border-gray-200 font-sans text-xs text-gray-950">{t('p-key')}</kbd>
          </Tooltip>
        </div>
      </div>
      ...
      <div className="mt-6">
        <div className="flex items-center justify-between">
          <span className="block text-sm font-medium text-gray-700">{t('password-label')}</span>
          <div className="flex items-center gap-2">
            <ButtonTooltip
