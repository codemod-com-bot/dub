        ...
        >
          <div className="flex items-center justify-between">
            ...
            <div className="max-md:hidden">
              <Tooltip
                content={
                  <div className="px-2 py-1 text-xs text-gray-700">{t('press-g-to-open-quickly', { "component0": <strong className="font-medium text-gray-950">{t('press-g-to-open-quickly_component0')}</strong> })}
                    </div>
                }
                side="right"
              >
                <kbd className="flex size-6 cursor-default items-center justify-center gap-1 rounded-md border border-gray-200 font-sans text-xs text-gray-950">{t('g')}</kbd>
              </Tooltip>
            </div>
          </div>
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <ProBadgeTooltip
                  content={
                    <SimpleTooltipContent
                      title={t('redirect-users-by-location')}
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <ProBadgeTooltip
                  content={
                    <SimpleTooltipContent
                      title={t('redirect-android-users')}
                      cta="Learn more about device targeting."
                      href="https://dub.co/help/article/device-targeting"
                    />
                  }
