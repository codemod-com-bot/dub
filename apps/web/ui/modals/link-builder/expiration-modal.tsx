        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <h3 className="text-lg font-medium">
              {t("link-expiration-title")}
            </h3>
            <ProBadgeTooltip
              content={
                <SimpleTooltipContent
                  title={t("link-expiration-description")}
                  cta="Learn more."
            ...
            <Tooltip
              content={
                <div className="px-2 py-1 text-xs text-neutral-700">
                  {t("link-expiration-quick-access", {
                    component0: (
                      <strong className="font-medium text-neutral-950">
                        {t("link-expiration-quick-access_component0")}
                      </strong>
                    ),
                  })}
                </div>
        ...
        <div className="mt-6">
          ...
          <div className="mt-2 flex w-full items-center justify-between rounded-md border border-neutral-300 bg-white shadow-sm transition-all focus-within:border-neutral-800 focus-within:outline-none focus-within:ring-1 focus-within:ring-neutral-500">
            <input
              ...
              id={`${id}-expiresAt`}
              type="text"
              placeholder={t("link-expiration-example")}
        ...
        <div className="mt-6">
          <div className="flex items-center gap-2">
            <label
              ...
              className="block text-sm font-medium text-neutral-700"
            >
              {t("link-expiration-url")}
            </label>
            <InfoTooltip
              content={
                <SimpleTooltipContent
                  title={t("link-expiration-url-description")}
                  cta="Learn more."
          ...
          <div className="mt-2 rounded-md shadow-sm">
            <input
              ...
              type="text"
              autoFocus={!isMobile}
              placeholder={t("link-expiration-example-url")}
              className={`${
                errors.expiredUrl
