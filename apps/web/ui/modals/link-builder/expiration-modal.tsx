  ...
  return (
    ...
    >
      ...
      >
            ...
            <Tooltip
              content={
                <div className="px-2 py-1 text-xs text-gray-700">
                  {t("quick-access-instruction", {
                    component0: (
                      <strong className="font-medium text-gray-950">
                        {t("quick-access-instruction_component0")}
                      </strong>
                    ),
                  })}
                </div>
        ...
        <div className="mt-6">
          ...
          <div className="mt-2 flex w-full items-center justify-between rounded-md border border-gray-300 bg-white shadow-sm transition-all focus-within:border-gray-800 focus-within:outline-none focus-within:ring-1 focus-within:ring-gray-500">
            <input
              ...
              id={`${id}-expiresAt`}
              type="text"
              placeholder={t("expiration-example")}
        ...
        <div className="mt-6">
          <div className="flex items-center gap-2">
            ...
            <InfoTooltip
              content={
                <SimpleTooltipContent
                  title={t("expiration-url-description")}
                  cta="Learn more."
        ...
        >
          {t("default-expiration-url-instruction")}
        </a>
