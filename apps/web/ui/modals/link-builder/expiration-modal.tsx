  ...
  return (
    ...
    >
      ...
      >
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <ProBadgeTooltip
              content={
                <SimpleTooltipContent
                  title={t("set-expiration-date-description")}
                  cta="Learn more."
            ...
            <Tooltip
              content={
                <div className="px-2 py-1 text-xs text-gray-700">
                  {t("shortcut-key-e-description", {
                    component0: (
                      <strong className="font-medium text-gray-950">
                        {t("shortcut-key-e-description_component0")}
                      </strong>
                    ),
                  })}
                </div>
        ...
        <div className="mt-6">
          ...
          <div className="mt-2 flex w-full items-center justify-between rounded-md border border-gray-300 bg-white shadow-sm transition-all focus-within:border-gray-800 focus-within:outline-none focus-within:ring-1 focus-within:ring-gray-500">
            <input
              ...
              id={`${id}-expiresAt`}
              type="text"
              placeholder={t("example-expiration-input")}
        ...
        <div className="mt-6">
          <div className="flex items-center gap-2">
            ...
            <InfoTooltip
              content={
                <SimpleTooltipContent
                  title={t("expiration-url-redirect-description")}
                  cta="Learn more."
          ...
          <div className="mt-2 rounded-md shadow-sm">
            <input
              ...
              type="text"
              autoFocus={!isMobile}
              placeholder={t("example-expiration-url")}
              className={`${
                errors.expiredUrl
        ...
        >
          {t("default-expiration-url-description")}
        </a>
