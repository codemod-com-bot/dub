    ...
    >
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <InfoTooltip
            content={
              <SimpleTooltipContent
                title={t('add-utm-parameters-to-your-short-links-for-conversion-tracking')}
                cta="Learn more."
        ...
        <div className="max-md:hidden">
          <Tooltip
            content={
              <div className="px-2 py-1 text-xs text-gray-700">{t('press-u-to-open-this-quickly', { "component0": <strong className="font-medium text-gray-950">{t('press-u-to-open-this-quickly_component0')}</strong> })}</div>
            }
            side="right"
          >
            <kbd className="flex size-6 cursor-default items-center justify-center rounded-md border border-gray-200 font-sans text-xs text-gray-950">{t('u')}</kbd>
          </Tooltip>
        </div>
      </div>
      ...
      {isValidUrl(url) && (
        <div className="mt-4 grid gap-y-1">
          <span className="block text-sm font-medium text-gray-700">{t('url-preview')}</span>
