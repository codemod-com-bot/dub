      ...
      >
        ...
        >
          ...
          <AnimatedSizeContainer height>
            <div className="p-1 pt-0 text-sm text-neutral-500">{t('api-key-scope-description', { "component0": {t('api-key-scope-description_component0', { "_scopePresets_find_p_p_value_preset_description_": _scopePresets_find_p_p_value_preset_description_ })} })}
