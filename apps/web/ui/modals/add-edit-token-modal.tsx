    ...
    <>
      ...
      >
        <h3 className="border-b border-neutral-200 px-4 py-4 text-lg font-medium sm:px-6">
          {token ? "Edit" : "Create New"}{t('api-key-description')}</h3>
        ...
        >
          <div>
            <label htmlFor="name">
              <h2 className="text-sm font-medium text-gray-900">{t('name-label')}</h2>
            </label>
          ...
          {!token && (
            <div>
              <h2 className="text-sm font-medium text-gray-900">{t('type-label')}</h2>
              <RadioGroup
                className="mt-2 flex"
                defaultValue="user"
                required
              ...
              >
                <div className="flex w-1/2 items-center space-x-2 rounded-md border border-gray-300 bg-white transition-all hover:bg-gray-50 active:bg-gray-100">
                  ...
                  >
                    <p className="text-gray-600">{t('you-label')}</p>
                    <InfoTooltip
                      content={
                        <SimpleTooltipContent
                          title={t('api-key-removal-warning')}
                          cta="Learn more"
                          href="https://dub.co/docs/api-reference/tokens"
                        />
                      }
                ...
                >
                  ...
                  >
                    <p className="text-gray-600">{t('machine-label')}</p>
                    <InfoTooltip
                      content={
                        <SimpleTooltipContent
                          title={
          ...
          <div className="flex flex-col gap-2">
            <h2 className="text-sm font-medium text-gray-900">{t('permissions-label')}</h2>
          ...
          <AnimatedSizeContainer height>
            <div className="p-1 pt-0 text-sm text-neutral-500">{t('api-key-scope-description', { "component0": {t('api-key-scope-description_component0', { "_scopePresets_find_p_p_value_preset_description_": <>{scopePresets.find((p) => p.value === preset)?.description}</> })} })}
