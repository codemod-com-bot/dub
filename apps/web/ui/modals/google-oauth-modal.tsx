    ...
    >
      <div className="flex flex-col items-center justify-center space-y-3 border-b border-gray-200 px-4 py-4 pt-8 sm:px-16">
        ...
        <p className="text-center text-sm text-gray-500">
          {t(
            "this-allows-you-to-sign-in-to-your-app-name-account-with-google-read-the-announcement",
            {
              ...
              component0: (
                ...
                >
                  {t(
                    "this-allows-you-to-sign-in-to-your-app-name-account-with-google-read-the-announcement_component0",
                  )}
                </a>
              ),
            },
