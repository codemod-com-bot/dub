...
const t = useTranslations("../ui/modals");
  ...
  return (
    <>
      ...
      >
        <div>
          <label htmlFor="verification" className="block text-sm text-gray-700">{t('verify-shortlink-input', { "component0": {t('verify-shortlink-input_component0', { "_shortlink_": <>{shortlink}</> })} })}</label>
