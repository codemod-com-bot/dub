  ...
  return (
    ...
    >
      <div className="flex flex-col items-center justify-center space-y-3 border-b border-gray-200 px-4 py-4 pt-8 sm:px-16">
        ...
        <p className="text-center text-sm text-gray-500">{t('deletion-warning')}</p>
      </div>
      ...
      >
        <div>
          <label htmlFor="verification" className="block text-sm text-gray-700">{t('verification-prompt', { "component0": {t('verification-prompt_component0', { "_oAuthApp_name_": <>{oAuthApp.name}</> })} })}
            </label>
