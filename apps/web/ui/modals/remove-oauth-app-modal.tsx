...
const t = useTranslations("../ui/modals");
  ...
  return (
    ...
    >
      ...
      >
        <div>
          <label htmlFor="verification" className="block text-sm text-gray-700">{t('verify-type-oauth-app-name', { "component0": {t('verify-type-oauth-app-name_component0', { "_oAuthApp_name_": _oAuthApp_name_ })} })}
            </label>
