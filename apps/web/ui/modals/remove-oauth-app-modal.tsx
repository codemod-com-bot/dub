  ...
  return (
    ...
    >
      <div className="flex flex-col items-center justify-center space-y-3 border-b border-gray-200 px-4 py-4 pt-8 sm:px-16">
        ...
        <h3 className="text-lg font-medium">{t('delete-oauth-app-name', { "oAuthApp_name": oAuthApp_name })}</h3>
        <p className="text-center text-sm text-gray-500">{t('deleting-application-invalidates-access-tokens')}</p>
      </div>
      ...
      >
        <div>
          <label htmlFor="verification" className="block text-sm text-gray-700">{t('verify-type-oauth-app-name-below', { "component0": {t('verify-type-oauth-app-name-below_component0', { "_oAuthApp_name_": _oAuthApp_name_ })} })}
            </label>
