  ...
  return (
    ...
    >
      <div className="flex flex-col items-center justify-center space-y-3 border-b border-gray-200 px-4 py-4 pt-8 sm:px-16">
        ...
        <h3 className="text-lg font-medium">{t('delete')}{oAuthApp.name}</h3>
      ...
      >
        <div>
          <label htmlFor="verification" className="block text-sm text-gray-700">{t('verify-deletion-instruction', { "component0": {t('verify-deletion-instruction_component0', { "_oAuthApp_name_": _oAuthApp_name_ })} })}
            </label>
