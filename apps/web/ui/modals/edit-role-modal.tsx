  ...
  return (
    <Modal showModal={showEditRoleModal} setShowModal={setShowEditRoleModal}>
      <div className="flex flex-col items-center justify-center space-y-3 border-b border-gray-200 px-4 py-4 pt-8 sm:px-16">
        ...
        <p className="text-center text-sm text-gray-500">{t('change-role-confirmation', { "component0": {t('change-role-confirmation_component0', { "_name_email_": <>{name || email}</> })}, "component1": {t('change-role-confirmation_component1', { "_workspaceName_": <>{workspaceName}</> })}, "component2": {t('change-role-confirmation_component2', { "_role_": <>{role}</> })} })}
          </p>
      </div>
