    ...
    >
      <div className="flex flex-col items-center justify-center space-y-3 border-b border-neutral-200 px-4 py-8 sm:px-16">
        ...
        <h3 className="text-lg font-medium">
          {t("import-rewardful-campaigns")}
        </h3>
        <p className="text-center text-sm text-neutral-500">
          {t("import-existing-rewardful-campaigns", {
      ...
      <div className="flex flex-col space-y-6 bg-neutral-50 px-4 py-8 text-left sm:px-16">
        {step === "token" ? (
          ...
          <div className="flex flex-col items-center justify-center space-y-4 bg-none">
            <LoadingSpinner />
            <p className="text-sm text-neutral-500">{t("loading-campaigns")}</p>
          </div>
        ) : campaigns ? (
          <CampaignsStep
            campaigns={campaigns}
    ...
    <form onSubmit={onSubmit} className="flex flex-col space-y-4">
      <div>
        ...
        <input
          ...
          placeholder={t("enter-rewardful-api-token")}
        ...
        <p className="mt-1.5 text-xs text-neutral-500">
          {t("find-rewardful-api-secret-link", {
            component0: (
              <a
              ...
              >
                {t("find-rewardful-api-secret-link_component0")}
              </a>
            ),
          })}
        </p>
    ...
    <form onSubmit={onSubmit} className="flex flex-col space-y-6">
      ...
      {selectedCampaign && (
        <dl className="grid grid-cols-2 gap-3 rounded-md border border-neutral-200 bg-white p-4 text-xs">
          <div>
            <dt className="text-neutral-500">{t("affiliates")}</dt>
          ...
          <div>
            <dt className="text-neutral-500">{t("commission-period")}</dt>
            <dd className="font-medium text-neutral-700">
