      ...
      {error?.status === 409 ? (
        <>
          <div className="flex flex-col items-center justify-center space-y-3 border-b border-gray-200 px-4 py-4 pt-8 sm:px-16">
            ...
            <p className="text-center text-sm text-gray-500">{t('workspace-invitation-details', { "component0": {t('workspace-invitation-details_component0', { "_slug_": <>{slug || "......"}</> })}, "process_env_NEXT_PUBLIC_APP_NAME": process.env.NEXT_PUBLIC_APP_NAME })}
        ...
        <>
          <div className="flex flex-col items-center justify-center space-y-3 border-b border-gray-200 px-4 py-4 pt-8 sm:px-16">
            ...
            <p className="text-center text-sm text-gray-500">{t('invite-expired-message')}</p>
          </div>
          <div className="flex flex-col space-y-6 bg-gray-50 px-4 py-8 text-left sm:px-16">
            <Button
