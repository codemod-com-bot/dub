  ...
  return (
    ...
    >
      <div className="flex flex-col items-center justify-center space-y-3 border-b border-gray-200 px-4 py-4 pt-8 sm:px-16">
        ...
        <p className="text-center text-sm text-gray-500">{t('warning-permanently-delete-account')}</p>
      </div>
      ...
      >
        <div>
          <label htmlFor="verification" className="block text-sm text-gray-700">{t('verify-confirm-delete-account', { "component0": <span className="font-semibold text-black">{t('verify-confirm-delete-account_component0')}</span> })}
            </label>
