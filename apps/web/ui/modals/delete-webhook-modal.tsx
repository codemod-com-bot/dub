...
const t = useTranslations("../ui/modals");
  ...
  return (
    ...
    >
      ...
      >
        <div>
          <label htmlFor="verification" className="block text-sm text-gray-700">{t('verify-webhook-name-message', { "component0": {t('verify-webhook-name-message_component0', { "_webhook_name_": _webhook_name_ })} })}
            </label>
