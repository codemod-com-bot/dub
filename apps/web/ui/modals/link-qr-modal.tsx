          ...
          <Tooltip
            content={
              <div className="px-2 py-1 text-xs text-gray-700">
                {t("press-q-to-open-quickly", {
                  component0: (
                    <strong className="font-medium text-gray-950">
                      {t("press-q-to-open-quickly_component0")}
                    </strong>
                  ),
                })}
              </div>
        ...
        <div className="flex items-center justify-between gap-2">
          <div className="flex items-center gap-2">
            ...
            <InfoTooltip
              content={
                <SimpleTooltipContent
                  title={t("customize-your-qr-code-to-fit-your-brand")}
                  cta="Learn more."
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <InfoTooltip
            content={
              <SimpleTooltipContent
                title={t("display-your-logo-in-the-center-of-the-qr-code")}
                cta="Learn more."
                href="https://dub.co/help/article/custom-qr-codes"
              />
            }
        ...
        <Switch
          ...
          disabledTooltip={
            plan === "free" ? (
              <TooltipContent
                title={t("pro-plan-required-for-logo-customization")}
                cta="Upgrade to Pro"
