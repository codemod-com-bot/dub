    ...
    >
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          <h3 className="text-lg font-medium">{t("qr-code-title")}</h3>
          <ProBadgeTooltip
            content={
              <SimpleTooltipContent
                title={t("qr-code-custom-design-description")}
                cta="Learn more."
          ...
          <Tooltip
            content={
              <div className="px-2 py-1 text-xs text-gray-700">
                {t("qr-code-quick-access-instruction", {
                  component0: (
                    <strong className="font-medium text-gray-950">
                      {t("qr-code-quick-access-instruction_component0")}
                    </strong>
                  ),
                })}
              </div>
        ...
        <div className="flex items-center justify-between gap-2">
          <div className="flex items-center gap-2">
            <span className="text-sm font-medium text-gray-700">
              {t("qr-code-preview-title")}
            </span>
            <InfoTooltip
              content={
                <SimpleTooltipContent
                  title={t("qr-code-customization-branding")}
                  cta="Learn more."
                  href="https://dub.co/help/article/custom-qr-codes"
                />
              }
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <InfoTooltip
            content={
              <SimpleTooltipContent
                title={t("qr-code-logo-display-description")}
                cta="Learn more."
                href="https://dub.co/help/article/custom-qr-codes"
              />
            }
        ...
        <Switch
          ...
          disabledTooltip={
            !plan || plan === "free" ? (
              <TooltipContent
                title={t("qr-code-logo-pro-plan-warning")}
                cta="Upgrade to Pro"
                href={
                  slug
