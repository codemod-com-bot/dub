      ...
      <div className="flex flex-col items-center justify-center space-y-3 border-b border-neutral-200 px-4 py-4 pt-8 sm:px-16">
        ...
        <div className="flex flex-col space-y-1 text-center">
          <h3 className="text-lg font-medium">
            {t("edit-or-create-tag", {
              propsEditCreate: props ? "Edit" : "Create",
            })}
          </h3>
          <p className="text-sm text-neutral-500">
            {t("use-tags-to-organize-links", {
              component0: (
                <a
                ...
                >
                  {t("use-tags-to-organize-links_component0")}
                </a>
              ),
            })}
          </p>
        ...
        <div>
          ...
          <div className="mt-2 flex rounded-md shadow-sm">
            <input
              ...
              placeholder={t("new-tag-placeholder")}
              value={name}
              onChange={(e) => {
...
function AddTagButton({
  ...
  return (
    <div>
      <Button
        variant="primary"
        text={t("create-tag-button")}
        className="h-9 rounded-lg"
        disabledTooltip={
          exceededTags ? (
            <TooltipContent
              title={t("tags-limit-warning", {
                tagsLimit: tagsLimit,
                pluralizeTagTagsLimit0: pluralize("tag", tagsLimit || 0),
