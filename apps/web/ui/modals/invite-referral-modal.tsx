  ...
  return (
    ...
    >
      <div className="flex flex-col items-center justify-center space-y-3 border-b border-gray-200 px-4 py-4 pt-8 sm:px-16">
        ...
        <p className="text-center text-sm text-gray-500">{t('invite-a-friend-or-colleague-to-use-dub-with-your-referral-link')}</p>
      </div>
      <form
        onSubmit={async (e) => {
          e.preventDefault();
      ...
      >
        <div>
          ...
          <p className="mt-2 text-xs text-gray-500">{t('your-name-and-email-address-will-be-shared-in-this-invitation')}</p>
        </div>
