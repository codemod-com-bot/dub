          ...
          <div>
            <div className="flex items-center space-x-1">
              ...
              <InfoTooltip
                content={
                  <SimpleTooltipContent
                    title={t('your-directory-provider-idp-explanation')}
              ...
              <div>
                <div className="flex items-center space-x-1">
                  ...
                  <InfoTooltip
                    content={
                      <SimpleTooltipContent
                        title={t('your-directory-provider-idp-explanation-duplicate')}
                        cta="Read the guide."
                        href={`https://dub.co/help/article/${currentProvider.saml}-scim`}
                      />
                    }
              ...
              <div>
                <div className="flex items-center space-x-1">
                  ...
                  <InfoTooltip
                    content={
                      <SimpleTooltipContent
                        title={t('your-directory-provider-idp-explanation-duplicate-2')}
                        cta="Read the guide."
                        href={`https://dub.co/help/article/${currentProvider.saml}-scim`}
                      />
                    }
