          ...
          <div>
            <div className="flex items-center space-x-1">
              <h2 className="text-sm font-medium text-gray-900">
                {t("directory-provider-title")}
              </h2>
              <InfoTooltip
                content={
                  <SimpleTooltipContent
                    title={t("directory-provider-description")}
            ...
            {currentProvider && (
              ...
              >
                {t("read-guide-scim", {
                  currentProvider_name: currentProvider.name,
                })}
              </a>
            )}
          </div>
              ...
              <div>
                <div className="flex items-center space-x-1">
                  ...
                  <InfoTooltip
                    content={
                      <SimpleTooltipContent
                        title={t("directory-provider-description-duplicate-1")}
                        cta="Read the guide."
                        href={`https://dub.co/help/article/${currentProvider.saml}-scim`}
                      />
                    }
              ...
              <div>
                <div className="flex items-center space-x-1">
                  ...
                  <InfoTooltip
                    content={
                      <SimpleTooltipContent
                        title={t("directory-provider-description-duplicate-2")}
                        cta="Read the guide."
                        href={`https://dub.co/help/article/${currentProvider.saml}-scim`}
                      />
                    }
