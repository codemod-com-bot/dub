  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col space-y-3 p-5 sm:p-10">
        <h2 className="text-xl font-medium">{t("delete-workspace-title")}</h2>
        <p className="text-sm text-gray-500">{t("delete-workspace-warning")}</p>
      </div>
      <div
      ...
      <div className="flex items-center justify-end px-5 py-4 sm:px-10">
        <div>
          <Button
            text={t("delete-workspace-title-quoted")}
            variant="danger"
