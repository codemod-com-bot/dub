      ...
      <div className="rounded-lg border border-gray-200 bg-white">
        <div className="relative flex flex-col space-y-6 p-5 sm:p-10">
          <div className="flex flex-col space-y-3">
            ...
            <p className="text-sm text-gray-500">{t('unique-id-of-your-workspace-on-dub')}</p>
          </div>
          {id ? (
        ...
        <div className="flex items-center justify-between rounded-b-lg border-t border-gray-200 bg-gray-50 px-3 py-5 sm:px-10">
          <p className="text-sm text-gray-500">{t('identify-your-workspace-when-interacting-with-dub-api', { "component0": <a
              href="https://dub.co/api"
              target="_blank"
              className="underline underline-offset-2 transition-colors hover:text-gray-700"
            >{t('identify-your-workspace-when-interacting-with-dub-api_component0')}</a> })}
            </p>
        </div>
      </div>
    </>
