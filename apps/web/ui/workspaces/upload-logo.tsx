  ...
  return (
    ...
    >
      <div className="flex flex-col space-y-3 p-5 sm:p-10">
        ...
        <p className="text-sm text-gray-500">{t('workspace-logo-description')}{process.env.NEXT_PUBLIC_APP_NAME}{t('workspace-logo-newline')}</p>
        <div className="mt-1">
          <FileUpload
            accept="images"
      ...
      <div className="flex items-center justify-between space-x-4 rounded-b-lg border-t border-gray-200 bg-gray-50 p-3 sm:px-10">
        <p className="text-sm text-gray-500">{t('workspace-logo-image-recommendation')}</p>
