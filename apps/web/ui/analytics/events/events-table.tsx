            ...
            <div className="flex items-center gap-3">
              {getValue() ? (
                <>
                  ...
                  <span className="truncate" title={t("qr-scan-1")}>
                    {t("qr-scan-2")}
                  </span>
                </>
              ) : (
                <>
                  ...
                  <span className="truncate" title={t("link-click-1")}>
                    {t("link-click-2")}
                  </span>
                </>
              )}
        ...
        // Sale amount
        {
          ...
          cell: ({ getValue }) => (
            <div className="flex items-center gap-2">
              ...
              <span className="text-neutral-400">{t("usd-1")}</span>
            </div>
          ),
        },
        // Sale invoice ID
