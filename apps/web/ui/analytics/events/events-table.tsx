            ...
            <div className="flex items-center gap-3">
              {getValue() ? (
                <>
                  ...
                  <span className="truncate" title={t("qr-scan")}>
                    {t("qr-scan-display")}
                  </span>
                </>
              ) : (
                <>
                  ...
                  <span className="truncate" title={t("link-click")}>
                    {t("link-click-display")}
                  </span>
                </>
              )}
            </div>
        ...
        // Sale amount
        {
          ...
          cell: ({ getValue }) => (
            <div className="flex items-center gap-2">
              ...
              <span className="text-neutral-400">{t("currency-usd")}</span>
            </div>
          ),
        },
        // Sale invoice ID
  ...
  const { table, ...tableProps } = useTable({
    ...
    emptyState: (
      <EmptyState
        ...
        description={t("events-placeholder-message", { tab: tab })}
      />
    ),
