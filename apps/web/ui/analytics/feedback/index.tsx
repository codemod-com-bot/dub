...
export default function Feedback() {
  const t = useTranslations("../ui/analytics/feedback");
      ...
      <AnimatePresence>
        {submitted ? (
          ...
          >
            ...
            <p className="text-neutral-500">{t("thank-you-feedback")}</p>
          </motion.div>
        ) : (
          <motion.form
            action={(data) =>
          ...
          >
            ...
            <div>
              ...
              <textarea
                ...
                rows={6}
                className="block w-full rounded-md border-neutral-300 text-neutral-900 placeholder-neutral-400 focus:border-neutral-500 focus:outline-none focus:ring-neutral-500 sm:text-sm"
                placeholder={t("data-request-question")}
                aria-invalid="true"
              />
            </div>
            <FormButton />
...
const FormButton = () => {
  ...
  return <Button text={t("submit-feedback-button")} loading={pending} />;
};
