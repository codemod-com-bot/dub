        ...
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-10 max-w-[500px] rounded border border-solid border-gray-200 px-10 py-5">
            ...
            <Text className="text-sm leading-6 text-gray-600">
              {t('strong-program-name-sent-sale-amount-affiliate-sales-dates', { "component0": {t('strong-program-name-sent-sale-amount-affiliate-sales-dates_component0', { "_program_name_": _program_name_ })}, "component1": {t('strong-program-name-sent-sale-amount-affiliate-sales-dates_component1', { "_saleAmountInDollars_": _saleAmountInDollars_ })}, "component2": {t('strong-program-name-sent-sale-amount-affiliate-sales-dates_component2', { "_payout_startDate_": _payout_startDate_ })}, "component3": {t('strong-program-name-sent-sale-amount-affiliate-sales-dates_component3', { "_payout_endDate_": _payout_endDate_ })} })}
