      ...
      <Tailwind>
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-10 max-w-[500px] rounded border border-solid border-gray-200 px-10 py-5">
            ...
            <Text className="text-sm leading-6 text-black">{t('your-domain-workspace-invalid', { "component0": {t('your-domain-workspace-invalid_component0', { "_domain_": _domain_ })}, "component1": <Link
                href={`https://app.dub.co/${workspaceSlug}`}
                className="font-medium text-blue-600 no-underline"
              >
                {t('your-domain-workspace-invalid_component1', { "workspaceSlug": workspaceSlug })}</Link>, "invalidDays": invalidDays })}
              </Text>
            <Text className="text-sm leading-6 text-black">{t('domain-unconfigured-notice')}</Text>
            ...
            <Text className="text-sm leading-6 text-black">{t('delete-domain-option', { "component0": <Link
                href={`https://app.dub.co/${workspaceSlug}/settings/domains`}
                className="font-medium text-blue-600 no-underline"
              >{t('delete-domain-option_component0')}</Link> })}
