...
const t = useTranslations("../emails");
  ...
  return (
    <Html>
      <Head />
      <Preview>{t('your-30-day-app-summary-for-workspace', { "appName": appName, "workspaceName": workspaceName })}
      </Preview>
      <Tailwind>
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-10 max-w-[500px] rounded border border-solid border-gray-200 px-10 py-5">
            ...
            <Heading className="mx-0 my-7 p-0 text-center text-xl font-semibold text-black">{t('your-30-day-app-summary-for-workspace-duplicate', { "appName": appName, "workspaceName": workspaceName })}
            </Heading>
            <Text className="text-sm leading-6 text-black">{t('last-30-days-workspace-received-link-clicks', { "appName": appName, "component0": {t('last-30-days-workspace-received-link-clicks_component0', { "_workspaceName_": _workspaceName_ })}, "component1": <strong>{nFormatter(totalClicks)}{t('last-30-days-workspace-received-link-clicks_component1')}</strong>, "component2": <strong>{t('last-30-days-workspace-received-link-clicks_component2', { "createdLinks": createdLinks })}</strong> })}
              ...
              <>
                ...
                <Section>
                  <Row className="pb-2">
                    ...
                    <Column align="right" className="text-sm text-gray-500">{t('clicks-label-duplicate')}</Column>
                  </Row>
