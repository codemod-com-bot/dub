...
const { t } = useTranslation("../emails");
  ...
  return (
    <Html>
      <Head />
      <Preview>{t('your-30-day-app-name-summary-for-workspace-name', { appName, workspaceName })}
      </Preview>
      <Tailwind>
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-10 max-w-[500px] rounded border border-solid border-gray-200 px-10 py-5">
            ...
            <Heading className="mx-0 my-7 p-0 text-center text-xl font-semibold text-black">{t('your-30-day-app-name-summary-for-workspace-name-duplicate', { appName, workspaceName })}
            </Heading>
            <Text className="text-sm leading-6 text-black"><Trans
i18nKey="in-the-last-30-days-your-app-name-workspace-workspace-name-received-link-clicks"
values={{ appName, _workspaceName_: <>{workspaceName}</>, createdLinks }}
components={{"0": 
              <strong />, "1": 
              <strong />, "2": <strong />}}
/></Text>
