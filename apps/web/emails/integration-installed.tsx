      ...
      <Tailwind>
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-10 max-w-[500px] rounded border border-solid border-gray-200 px-10 py-5">
            ...
            <Text className="text-sm leading-6 text-black">{t('the-integration-name-has-been-added-to-your-workspace-workspace-name-on-dub', { "component0": {t('the-integration-name-has-been-added-to-your-workspace-workspace-name-on-dub_component0', { "_integration_name_": _integration_name_ })}, "workspace_name": workspace_name })}</Text>
