...
const t = useTranslations("../emails");
  ...
  return (
    <Html>
      <Head />
      <Preview>{t('your-dubco-workspace')}{name || ""}{t('has-exceeded-the')}
      ...
      <Tailwind>
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-10 max-w-[500px] rounded border border-solid border-gray-200 px-10 py-5">
            ...
            <Text className="text-sm leading-6 text-black">{t('your-dubco-workspace-exceeded-plan-limit', { "component0": {t('your-dubco-workspace-exceeded-plan-limit_component0', { "_strong_name_strong_": _strong_name_strong_ })}, "component1": <strong>{t('your-dubco-workspace-exceeded-plan-limit_component1')}{capitalize(plan)}{t('your-dubco-workspace-exceeded-plan-limit_component1')}</strong>, "component2": <strong>{nFormatter(usageLimit)}{t('your-dubco-workspace-exceeded-plan-limit_component2')}</strong>, "component3": <strong>{nFormatter(usage, { digits: 2 })}{t('your-dubco-workspace-exceeded-plan-limit_component3')}</strong> })}
            ...
            <Text className="text-sm leading-6 text-black">{t('existing-links-continue-to-work', { "component0": <Link
              ...
              >
                {t('existing-links-continue-to-work_component0', { "nextPlan_name": nextPlan_name })}</Link> })}
              </Text>
