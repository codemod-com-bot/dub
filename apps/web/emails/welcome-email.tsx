      ...
      <Tailwind>
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-10 max-w-[500px] rounded border border-solid border-gray-200 px-10 py-5">
            ...
            <Text className="text-sm leading-6 text-black">
              {t("founder-introduction-steven")}
            </Text>
            <Text className="text-sm leading-6 text-black">
              {t("things-you-can-do")}
            </Text>
            <Text className="ml-1 text-sm leading-4 text-black">
              {t("create-new-workspace-and-add-domain", {
                component0: (
                  <Link
                    href="https://app.dub.co?newWorkspace=true"
                    className="font-medium text-blue-600 no-underline"
                  >
                    {t("create-new-workspace-and-add-domain_component0")}
                  </Link>
                ),
                component1: (
                  <Link
                    ...
                    className="font-medium text-blue-600 no-underline"
                  >
                    {t("create-new-workspace-and-add-domain_component1")}
                  </Link>
                ),
              })}
            </Text>
