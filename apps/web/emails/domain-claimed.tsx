      ...
      <Tailwind>
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-10 max-w-[500px] rounded border border-solid border-gray-200 px-10 py-5">
            ...
            <Text className="text-sm leading-6 text-black">{t('congratulations-claimed-free-domain-dub-workspace', { "component0": {t('congratulations-claimed-free-domain-dub-workspace_component0', { "_domain_": _domain_ })}, "component1": <Link
                href={`https://app.dub.co/${workspaceSlug}`}
                className="font-medium text-blue-600 no-underline"
              >
                {t('congratulations-claimed-free-domain-dub-workspace_component1', { "workspaceSlug": workspaceSlug })}</Link> })}
            ...
            <Text className="text-sm leading-6 text-black">{t('domain-provisioning-time')}</Text>
