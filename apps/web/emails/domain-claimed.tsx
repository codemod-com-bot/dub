      ...
      <Tailwind>
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-10 max-w-[500px] rounded border border-solid border-gray-200 px-10 py-5">
            ...
            <Text className="text-sm leading-6 text-black">{t('domain-provisioning-notice')}</Text>
            <Text className="text-sm leading-6 text-black">{t('domain-activation-follow-up')}</Text>
            <Footer email={email} />
          </Container>
        </Body>
      </Tailwind>
