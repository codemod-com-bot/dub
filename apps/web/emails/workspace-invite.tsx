          ...
          <Container className="mx-auto my-10 max-w-[500px] rounded border border-solid border-gray-200 px-10 py-5">
            ...
            {workspaceUser && workspaceUserEmail ? (
              <Text className="text-sm leading-6 text-black">
                {t('workspace-user-invitation-message', { "component0": {t('workspace-user-invitation-message_component0', { "_workspaceUser_": _workspaceUser_ })}, "component1": {t('workspace-user-invitation-message_component1', { "_workspaceUserEmail_": _workspaceUserEmail_ })}, "component2": {t('workspace-user-invitation-message_component2', { "_workspaceName_": _workspaceName_ })}, "appName": appName })}</Text>
            ) : (
            ...
            <Text className="text-sm leading-6 text-black">{t('copy-paste-url-instructions')}</Text>
