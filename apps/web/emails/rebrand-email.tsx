      ...
      <Tailwind>
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-10 max-w-[500px] rounded border border-solid border-gray-200 px-10 py-5">
            ...
            <Text className="text-sm leading-6 text-black">
              {t("email-whitelist-request", {
                component0: (
                  <strong>{t("email-whitelist-request_component0")}</strong>
                ),
                component1: (
                  <strong>{t("email-whitelist-request_component1")}</strong>
                ),
                component2: (
                  <strong>{t("email-whitelist-request_component2")}</strong>
                ),
              })}
            </Text>
            <Hr />
            ...
            <Text className="ml-1 text-sm leading-6 text-black">
              {t("dub-help-center-feature", {
                component0: (
                  <Link
                    href="https://dub.co/help"
                    className="font-bold text-blue-600 no-underline"
                  >
                    {t("dub-help-center-feature_component0")}
                  </Link>
                ),
              })}
            </Text>
              ...
              {t("changelog-introduction", {
                component0: (
                  <Link
                    ...
                    className="font-medium text-blue-600 no-underline"
                  >
                    {t("changelog-introduction_component0")}
                  </Link>
                ),
              })}
            </Text>
