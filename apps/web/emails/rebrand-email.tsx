        ...
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-10 max-w-[500px] rounded border border-solid border-gray-200 px-10 py-5">
            ...
            <Text className="ml-1 text-sm leading-6 text-black">
              {t("migration-assistants-link", {
                component0: (
                  <Link
                    href="https://dub.co/blog/migration-assistants"
                    className="font-bold text-blue-600 no-underline"
                  >
                    {t("migration-assistants-link_component0")}
                  </Link>
                ),
              })}
            </Text>
            <Text className="ml-1 text-sm leading-6 text-black">
              {t("dub-help-center-link", {
                component0: (
                  <Link
                    href="https://dub.co/help"
                    className="font-bold text-blue-600 no-underline"
                  >
                    {t("dub-help-center-link_component0")}
                  </Link>
                ),
              })}
            </Text>
            ...
            <Text className="text-sm leading-6 text-black">
              {t("check-out-changelog", {
                component0: (
                  <Link
                    href="https://dub.co/changelog"
                    className="font-medium text-blue-600 no-underline"
                  >
                    {t("check-out-changelog_component0")}
                  </Link>
                ),
              })}
            </Text>
