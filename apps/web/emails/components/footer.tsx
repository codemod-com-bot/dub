...
const t = useTranslations("../emails/components");
  ...
  return (
    <Tailwind>
      ...
      {notificationSettingsUrl && (
        <Text className="text-[12px] leading-6 text-gray-500">{t('dont-want-to-get-these-emails-adjust-notification-settings', { "component0": <Link
            className="text-gray-700 underline"
            href={notificationSettingsUrl}
          >{t('dont-want-to-get-these-emails-adjust-notification-settings_component0')}</Link> })}
