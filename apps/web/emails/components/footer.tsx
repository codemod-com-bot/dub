...
const t = useTranslations("../emails/components");
  ...
  return (
    <Tailwind>
      <Hr className="mx-0 my-6 w-full border border-gray-200" />
      <Text className="text-[12px] leading-6 text-gray-500">{t('this-email-was-intended-for-email-if-you-were-not-expecting-this-email-you-can-ignore-this-email', { "component0": {t('this-email-was-intended-for-email-if-you-were-not-expecting-this-email-you-can-ignore-this-email_component0', { "_email_": _email_ })} })}</Text>
