      ...
      <Tailwind>
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-10 max-w-[500px] rounded border border-solid border-gray-200 px-10 py-5">
            ...
            <Heading className="mx-0 my-7 p-0 text-center text-xl font-semibold text-black">{t('new-workspace-api-key-created-2')}</Heading>
            ...
            <Text className="text-sm leading-6 text-black">{t('strong-token-type-has-permissions', { "component0": {t('strong-token-type-has-permissions_component0', { "_token_type_": _token_type_ })}, "token_permissions": token_permissions })}
              </Text>
            ...
            <Text className="text-sm leading-6 text-black">{t('if-not-created-delete-this-key', { "component0": {t('if-not-created-delete-this-key_component0', { "_strong_delete_this_key_strong_": _strong_delete_this_key_strong_ })} })}
              </Text>
            <Footer email={email} />
          </Container>
        </Body>
