      ...
      <Tailwind>
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-10 max-w-[500px] rounded border border-solid border-gray-200 px-10 py-5">
            ...
            <Heading className="mx-0 my-7 p-0 text-center text-xl font-semibold text-black">{t('some-provider-links-have-failed-to-import', { provider })}</Heading>
            <Text className="text-sm leading-6 text-black">{t('the-following')}
              {Intl.NumberFormat("en-us").format(errorLinks.length)}<Trans
i18nKey="links-from-provider-failed-to-import-into-your-dub-co-workspace"
