        ...
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-10 max-w-[500px] rounded border border-solid border-gray-200 px-10 py-5">
            ...
            <Heading className="mx-0 my-7 p-0 text-center text-xl font-semibold text-black">
              {t("some-provider-links-failed-import", { provider: provider })}
            </Heading>
            <Text className="text-sm leading-6 text-black">
              {t("following-links")}
              {Intl.NumberFormat("en-us").format(errorLinks.length)}
              {t("links-failed-import-into-workspace", {
                provider: provider,
                component0: (
                  <Link
                  ...
                  >
                    {t("links-failed-import-into-workspace_component0", {
            ...
            <Text className="text-sm leading-6 text-black">
              {t("csv-import-help-notification")}
            </Text>
            <Footer email={email} />
          </Container>
        </Body>
