...
const t = useTranslations("partners.dub.co/(onboarding)/onboarding");
  ...
  return (
    ...
    >
      <label>
        <span className="text-sm font-medium text-gray-800">{t('full-name-required', { "component0": <span className="font-normal text-neutral-500">{t('full-name-required_component0')}</span> })}
        </span>
        <input
          type="text"
          className={cn(
      ...
      <label>
        <span className="text-sm font-medium text-gray-800">{t('email-required', { "component0": <span className="font-normal text-neutral-500">{t('email-required_component0')}</span> })}
        </span>
        <input
          type="text"
          className={cn(
      ...
      <label>
        <span className="text-sm font-medium text-gray-800">{t('display-image-required', { "component0": <span className="font-normal text-neutral-500">{t('display-image-required_component0')}</span> })}
        </span>
      ...
      <label>
        <span className="text-sm font-medium text-gray-800">{t('country-required', { "component0": <span className="font-normal text-neutral-500">{t('country-required_component0')}</span> })}
        </span>
        <Controller
          control={control}
          name="country"
