...
const t = useTranslations("partners.dub.co/(apply)/apply/[programSlug]/application/success");
    ...
    >
      <g clipPath={`url(#${id}-a)`}>
        ...
        <text
          ...
          style={{ whiteSpace: "pre" }}
        >
          <tspan x="68" y="97.636">{t('enrolled')}</tspan>
        </text>
        <g clipPath={`url(#${id}-e)`}>
          ...
          <text
            ...
            style={{ whiteSpace: "pre" }}
          >
            <tspan x="46" y="143.727">{t('overview-1')}</tspan>
          </text>
        </g>
        <path
          stroke="#737373"
        ...
        <text
          ...
          style={{ whiteSpace: "pre" }}
        >
          <tspan x="46" y="173.727">{t('payouts')}</tspan>
        </text>
        <g
          stroke="#737373"
          strokeLinecap="round"
        ...
        <text
          ...
          style={{ whiteSpace: "pre" }}
        >
          <tspan x="46" y="203.727">{t('events')}</tspan>
        </text>
        <path
          stroke="#737373"
          strokeLinecap="round"
        ...
        <text
          ...
          style={{ whiteSpace: "pre" }}
        >
          <tspan x="46" y="233.727">{t('links')}</tspan>
        </text>
        <path
          stroke="#737373"
          strokeLinecap="round"
        ...
        <text
          ...
          style={{ whiteSpace: "pre" }}
        >
          <tspan x="46" y="263.727">{t('resources')}</tspan>
        </text>
        <path
          fill="#fff"
        ...
        <text
          ...
          style={{ whiteSpace: "pre" }}
        >
          <tspan x="367.5" y="72.727">{t('overview-2')}</tspan>
        </text>
        <g clipPath={`url(#${id}-h)`}>
          <rect
            width="1200"
          ...
          <text
            ...
            style={{ whiteSpace: "pre" }}
          >
            <tspan x="417.5" y="142.091">{t('refer-and-earn')}</tspan>
          </text>
          <text
            xmlSpace="preserve"
            fill="#171717"
          ...
          >
            ...
            <tspan>{t('for-each-conversion-and-again')}</tspan>
            <tspan fontWeight="600">{t('every-month')}</tspan>
          </text>
          <text
            xmlSpace="preserve"
            fill="#171717"
            ...
            x="391.5"
            y="289.045"
          >{t('for-the-customers-lifetime')}</text>
          <text
            xmlSpace="preserve"
            fill="#262626"
            fontSize="14"
            ...
            style={{ whiteSpace: "pre" }}
          >
            <tspan x="391.5" y="334.091">{t('referral-link')}</tspan>
          </text>
          <path
            fill="#fff"
          ...
          <text
            ...
            style={{ whiteSpace: "pre" }}
          >
            <tspan x="403.5" y="371.091">{t('refer-dub-co-steven')}</tspan>
          </text>
          <path
            stroke="#737373"
            strokeLinecap="round"
          ...
          <text
            ...
            style={{ whiteSpace: "pre" }}
          >
            <tspan x="743.521" y="371.091">{t('invite-via-email')}</tspan>
          </text>
        ...
        <text
          ...
          style={{ whiteSpace: "pre" }}
        >
          <tspan x="391.5" y="470.591">{t('earnings')}</tspan>
        </text>
        <text
          xmlSpace="preserve"
          fill="#262626"
        ...
        <text
          ...
          style={{ whiteSpace: "pre" }}
        >
          <tspan x="1436.5" y="478.364">{t('last-24-hours')}</tspan>
        </text>
        <path
          stroke="#A3A3A3"
          strokeLinecap="round"
        ...
        <text
          ...
          style={{ whiteSpace: "pre" }}
        >
          <tspan x="431.5" y="856.864">{t('oct-1')}</tspan>
        </text>
        <text
          xmlSpace="preserve"
          fill="#525252"
          ...
          style={{ whiteSpace: "pre" }}
        >
          <tspan x="605.167" y="856.864">{t('oct-5')}</tspan>
        </text>
        <text
          xmlSpace="preserve"
          fill="#525252"
          ...
          style={{ whiteSpace: "pre" }}
        >
          <tspan x="779.833" y="856.864">{t('oct-10')}</tspan>
        </text>
        <text
          xmlSpace="preserve"
          fill="#525252"
          ...
          style={{ whiteSpace: "pre" }}
        >
          <tspan x="960.5" y="856.864">{t('oct-15')}</tspan>
        </text>
        <text
          xmlSpace="preserve"
          fill="#525252"
          ...
          style={{ whiteSpace: "pre" }}
        >
          <tspan x="1141.17" y="856.864">{t('oct-20')}</tspan>
        </text>
        <text
          xmlSpace="preserve"
          fill="#525252"
          ...
          style={{ whiteSpace: "pre" }}
        >
          <tspan x="1323.83" y="856.864">{t('oct-25')}</tspan>
        </text>
        <text
          xmlSpace="preserve"
          fill="#525252"
          ...
          style={{ whiteSpace: "pre" }}
        >
          <tspan x="1506.5" y="856.864">{t('oct-31')}</tspan>
        </text>
        <mask
          id={`${id}-z`}
          width="1112"
