    ...
    >
      ...
      <label>
        <span className="text-sm font-medium text-gray-800">
          {t("website-social-media-channel-optional", {
            component0: (
              <span className="font-normal text-neutral-500">
                {t("website-social-media-channel-optional_component0")}
              </span>
            ),
          })}
        </span>
      ...
      <label>
        <span className="text-sm font-medium text-gray-800">
          {t("additional-questions-comments-optional", {
            component0: (
              <span className="font-normal text-neutral-500">
                {t("additional-questions-comments-optional_component0")}
              </span>
            ),
          })}
        </span>
