...
const t = await getTranslations("partners.dub.co/(apply)/apply/[programSlug]");
    ...
    >
      ...
      <div className="p-6">
        ...
        <div className="grid grid-cols-1 gap-5 sm:pt-20">
          ...
          >{t('join-the')}{program.name}{t('affiliate-program-description')}</h1>
          <p
            className={cn(
          ...
          >{t('share')}{program.name}{t('audience-share-revenue')}</p>
