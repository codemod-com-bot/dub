  ...
  return (
    <>
      <div className="rounded-lg border border-neutral-200 bg-white p-8 pb-10">
        ...
        <p className="mt-3 text-sm text-gray-500">{t('enter-verification-code-sent-to-email', { "component0": {t('enter-verification-code-sent-to-email_component0', { "_truncate_email_30_": _truncate_email_30_ })} })}
