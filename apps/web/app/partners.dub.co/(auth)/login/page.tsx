  ...
  return (
    <div className="mx-auto my-10 w-full max-w-md md:mt-16 lg:mt-20">
      <div className="rounded-lg border border-neutral-200 bg-white p-8 pb-10">
        <h1 className="text-lg font-medium text-neutral-800">{t('sign-in-to-your-dub-partner-account')}</h1>
        <div className="mt-8">
          <ClientOnly>
            <LoginForm
      ...
      <p className="mt-4 text-center text-sm text-gray-500">{t('dont-have-an-account-sign-up', { "component0": <Link
          href="register"
          className="font-semibold text-gray-500 underline underline-offset-2 transition-colors hover:text-black"
        >{t('dont-have-an-account-sign-up_component0')}</Link> })}
