...
const { t } = useTranslation("inspect/[domain]/[key]");
    ...
    <>
      <main className="flex min-h-screen flex-col justify-between">
        ...
        <div className="z-10 mx-2 my-10 flex max-w-md flex-col space-y-5 px-2.5 text-center sm:mx-auto sm:max-w-lg sm:px-0 lg:mb-16">
          <h1 className="font-display text-5xl font-extrabold leading-[1.15] text-black sm:text-6xl sm:leading-[1.15]">{t('link-inspector')}</h1>
          <h2 className="text-lg text-gray-600 sm:text-xl">{t('inspect-short-link-description')}</h2>
          ...
          >{t('inspect-another-short-link')}</a>
        </div>
        <Footer />
        <Background />
      </main>
