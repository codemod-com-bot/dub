        ...
        {data.workspaces.map((workspace) => (
          ...
          >
            ...
            <div className="flex justify-between text-sm">
              <span className="font-medium text-neutral-700">{t("id")}</span>
              <span className="text-neutral-500">{workspace.id}</span>
            </div>
            <div className="flex justify-between text-sm">
              <span className="font-medium text-neutral-700">{t("plan")}</span>
            ...
            <div className="flex justify-between text-sm">
              <span className="font-medium text-neutral-700">{t("links")}</span>
              <span className="text-neutral-500">
