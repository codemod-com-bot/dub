    ...
    >
      ...
      >
        ...
        <motion.p
          ...
          variants={STAGGER_CHILD_VARIANTS}
        >
          {t('inline-snippet-custom-domain-link', { "component0": {t('inline-snippet-custom-domain-link_component0', { "_domain_": _domain_ })}, "component1": {t('inline-snippet-custom-domain-link_component1', { "_process_env_NEXT_PUBLIC_APP_NAME_": _process_env_NEXT_PUBLIC_APP_NAME_ })} })}
          </motion.p>
        <motion.a
          variants={STAGGER_CHILD_VARIANTS}
