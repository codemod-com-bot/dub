  ...
  return (
    <main className="flex min-h-screen flex-col justify-between">
      ...
      <div className="z-10 mx-2 my-10 flex max-w-md flex-col items-center space-y-5 px-2.5 text-center sm:mx-auto sm:max-w-lg sm:px-0 lg:mb-16">
        ...
        <h1 className="font-display text-5xl font-bold">{t('banned-link')}</h1>
        <p className="text-lg text-gray-600">{t('this-link-has-been-banned-for-violating-our-terms-of-service')}</p>
        <a
          href="https://dub.co/home"
          className="rounded-full bg-gray-800 px-10 py-2 font-medium text-white transition-colors hover:bg-black"
        >{t('create-your-free-branded-link')}</a>
      </div>
      <Footer />
      <Background />
    </main>
