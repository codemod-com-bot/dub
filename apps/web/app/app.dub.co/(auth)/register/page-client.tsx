...
function Verify() {
  ...
  return (
    <>
      ...
      <p className="mt-4 text-center text-sm text-gray-500">
        {t("already-have-an-account-sign-in-link-duplicate", {
          component0: (
            <Link
              href="/login"
              className="font-semibold text-gray-500 underline underline-offset-2 transition-colors hover:text-black"
            >
              {t("already-have-an-account-sign-in-link-duplicate_component0")}
            </Link>
          ),
        })}
      </p>
