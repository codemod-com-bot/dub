...
const t = useTranslations("app.dub.co/(onboarding)/onboarding/(steps)/domain");
  ...
  return isWorkspaceLoading ? (
    ...
    <>
      <div className="animate-fade-in mx-auto grid w-full max-w-[312px] gap-4 sm:max-w-2xl sm:grid-cols-2">
        ...
        <DomainOption
          title={
            <>{t('claim-a-free-link-domain', { "component0": <span className="rounded border border-green-800/10 bg-lime-100 p-1 font-mono text-xs">{t('claim-a-free-link-domain_component0')}</span> })}
              </>
          }
          example="acme.link"
