    ...
    <>
      <Alert>
        ...
        <AlertDescription className="text-gray-500">
          {t("recommend-create-workspace-api-key", {
            component0: (
              <a
              ...
              >
                {t("recommend-create-workspace-api-key_component0")}
              </a>
            ),
            component1: (
              <a
                ...
                className="font-medium underline underline-offset-4 hover:text-black"
              >
                {t("recommend-create-workspace-api-key_component1")}
              </a>
            ),
          })}
        </AlertDescription>
