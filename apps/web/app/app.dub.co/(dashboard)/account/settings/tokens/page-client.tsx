...
const { t } = useTranslation("app.dub.co/(dashboard)/account/settings/tokens");
  ...
  return (
    <>
      <Alert>
        ...
        <AlertDescription className="text-gray-500"><Trans
i18nKey="recommend-creating-new-workspace-api-key"
components={{"0": 
          <a
      ...
      <div className="rounded-lg border border-gray-200 bg-white">
        ...
        {isLoading || !tokens ? (
          ...
          <div className="flex flex-col items-center justify-center space-y-4 pb-20 pt-10">
            ...
            <p className="text-sm text-gray-500">{t('no-api-keys-found-create-one-above')}</p>
          </div>
        )}
      </div>
    </>
