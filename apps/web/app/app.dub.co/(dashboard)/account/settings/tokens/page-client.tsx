  ...
  return (
    <>
      <Alert>
        ...
        <AlertTitle>{t('user-api-keys-replaced-by-workspace-api-keys')}</AlertTitle>
        <AlertDescription className="text-gray-500">{t('recommend-creating-new-workspace-api-key', { "component0": <a
            href="https://dub.co/docs/api-reference/tokens"
            target="_blank"
            className="font-medium underline underline-offset-4 hover:text-black"
          >{t('recommend-creating-new-workspace-api-key_component0')}</a>, "component1": <a
            href="https://dub.co/blog/workspace-api-keys"
            target="_blank"
            className="font-medium underline underline-offset-4 hover:text-black"
          >{t('recommend-creating-new-workspace-api-key_component1')}</a> })}
      ...
      <div className="rounded-lg border border-gray-200 bg-white">
        <div className="flex flex-col space-y-3 p-5 sm:p-10">
          ...
          <p className="text-sm text-gray-500">{t('api-keys-allow-access-with-caution')}</p>
        </div>
        {isLoading || !tokens ? (
          ...
          <div className="flex flex-col items-center justify-center space-y-4 pb-20 pt-10">
            ...
            <p className="text-sm text-gray-500">{t('no-api-keys-found-create-one')}</p>
          </div>
        )}
      </div>
    </>
      ...
      <div className="relative grid grid-cols-5 items-center px-5 py-3 sm:px-10">
        <div className="col-span-3 flex items-center space-x-3">
          ...
          <div className="flex flex-col space-y-px">
            ...
            <p className="text-sm text-gray-500" suppressHydrationWarning>{t('created')}{timeAgo(token.createdAt, { withAgo: true })}
            </p>
          </div>
        </div>
