    ...
    <div className="rounded-lg border border-gray-200 bg-white">
      <div className="flex flex-col gap-3 border-b border-gray-200 p-5 sm:p-10">
        ...
        <p className="pb-2 text-sm text-gray-500">
          {user?.provider && (
            <>{t('your-account-is-managed-by-user-provider', { "component0": {t('your-account-is-managed-by-user-provider_component0', { "_user_provider_": _user_provider_ })} })}
              
            </>
          )}{t('you-can-set-a-password-to-use-with-your-dub-account')}</p>
      </div>
