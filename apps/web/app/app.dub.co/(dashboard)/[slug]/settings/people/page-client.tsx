...
const { t } = useTranslation("app.dub.co/(dashboard)/[slug]/settings/people");
      ...
      <div className="rounded-lg border border-gray-200 bg-white">
        <div className="flex flex-col items-center justify-between space-y-3 p-5 sm:flex-row sm:space-y-0 sm:p-10">
          <div className="flex flex-col space-y-3">
            ...
            <p className="text-sm text-gray-500">{t('teammates-that-have-access-to-this-workspace')}</p>
          </div>
            ...
            users.length > 0 ? (
              ...
              <div className="flex flex-col items-center justify-center py-10">
                <img
                  ...
                  alt={t('no-invitations-sent-quote')}
                  width={300}
                  height={300}
                  className="pointer-events-none -my-8"
                />
                <p className="text-sm text-gray-500">{t('no-invitations-sent')}</p>
              </div>
            )
          ) : (
    ...
    <>
      ...
      >
        <div className="flex items-start space-x-3">
          ...
          {expiredInvite && <Badge variant="gray">{t('expired')}</Badge>}
        </div>
