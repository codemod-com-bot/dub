...
const t = useTranslations("app.dub.co/(dashboard)/[slug]/settings/notifications");
  ...
  return (
    <div>
      <div className="max-w-screen-sm pb-8">
        ...
        <p className="mt-3 text-sm text-gray-500">{t('adjust-your-personal-notification-preferences')}</p>
      </div>
