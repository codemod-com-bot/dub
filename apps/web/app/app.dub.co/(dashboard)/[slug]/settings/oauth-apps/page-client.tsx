...
const t = useTranslations("app.dub.co/(dashboard)/[slug]/settings/oauth-apps");
    ...
    <div className="grid gap-5">
      <div className="flex flex-wrap justify-between gap-6">
        <div className="flex items-center gap-x-2">
          <h1 className="text-2xl font-semibold tracking-tight text-black">{t('oauth-applications-title')}</h1>
          <InfoTooltip
            content={
              <TooltipContent
                title={t('learn-how-to-use-oauth-applications')}
