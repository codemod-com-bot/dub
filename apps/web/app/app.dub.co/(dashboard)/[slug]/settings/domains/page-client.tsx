      ...
      <div className="grid gap-5">
        <div className="flex flex-wrap justify-between gap-6">
          <div className="flex items-center gap-x-2">
            <h1 className="text-2xl font-semibold tracking-tight text-black">{t('domains')}</h1>
            <InfoTooltip
              content={
                <TooltipContent
                  title={t('learn-more-about-adding-configuring-and-verifying-custom-domains-on-dub')}
          ...
          <div className="flex w-full flex-wrap items-center gap-3 sm:w-auto">
            ...
            <Popover
              content={
                <div className="grid w-screen gap-px p-2 sm:w-fit sm:min-w-[17rem]">
                  ...
                  <Button
                    text={
                      <div className="flex items-center gap-3">{t('claim-free-link-domain')}{plan === "free" ? (
                          <Badge
                            variant="neutral"
                          ...
                          <span className="rounded-md border border-green-200 bg-green-500/10 px-1 py-0.5 text-xs text-green-900">{t('claimed')}</span>
                        ) : null}
                      </div>
                    }
                    variant="outline"
            ...
            >
              <Button
                ...
                text={
                  <div className="flex items-center gap-2">{t('add-domain')}
          ...
          {!loading ? (
            allWorkspaceDomains.length > 0 ? (
              ...
              <AnimatedEmptyState
                ...
                description={t('use-custom-domains-for-better-brand-recognition-and-click-through-rates')}
                cardContent={
                  <>
