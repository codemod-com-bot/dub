  ...
  return (
    <div className="my-10 grid gap-5 border-t border-gray-200 py-10">
      <div>
        ...
        <p className="mt-3 text-sm text-gray-500">{t('leverage-default-branded-domains', { "component0": <Link
            href="https://dub.co/help/article/default-dub-domains"
            target="_blank"
            className="underline transition-colors hover:text-gray-800"
          >{t('leverage-default-branded-domains_component0')}</Link> })}
              ...
              <Switch
                ...
                disabledTooltip={
                  ...
                  (slug === "dub.link" && plan === "free" ? (
                    <TooltipContent
                      title={t('pro-plan-upgrade-message')}
                      cta="Upgrade to Pro"
                      href={`/${slug}/upgrade`}
                    />
                  ) : undefined)
