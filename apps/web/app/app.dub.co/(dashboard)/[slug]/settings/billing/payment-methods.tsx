      ...
      <div className="grid gap-4 border-t border-neutral-200 p-6">
        {regularPaymentMethods ? (
          regularPaymentMethods.length > 0 ? (
            ...
            <AnimatedEmptyState
              title={t("no-payment-methods-found-message")}
              description={t("no-payment-methods-added-message")}
              cardContent={() => (
                <>
          ...
          <div className="flex items-center gap-2">
            ...
            {type === "us_bank_account" && (
              <Badge variant="neutral">
                {t("recommended-for-partners-description")}
              </Badge>
            )}
          </div>
