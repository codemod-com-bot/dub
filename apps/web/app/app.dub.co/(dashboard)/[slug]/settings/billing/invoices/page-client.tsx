...
const t = useTranslations("app.dub.co/(dashboard)/[slug]/settings/billing/invoices");
      ...
      <div className="flex flex-col items-start justify-between gap-y-4 p-4 md:pt-6 xl:flex-row">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-balance text-sm leading-normal text-neutral-500">{t('history-of-all-your-dub-invoices')}</p>
          </div>
        </div>
      </div>
      {payoutMethodId && (
        ...
        {invoices ? (
          invoices.length > 0 ? (
            ...
            <AnimatedEmptyState
              ...
              description={t('you-dont-have-any-invoices-yet')}
              cardContent={() => (
                <>
