      ...
      <div className="grid divide-y divide-neutral-200 border-t border-neutral-200">
        {invoices ? (
          invoices.length > 0 ? (
            ...
            <AnimatedEmptyState
              title={t("invoices-no-invoices-found")}
              description={t("invoices-no-invoices-yet")}
              cardContent={() => (
                <>
  ...
  return (
    <div className="grid grid-cols-3 gap-4 px-6 py-4 sm:px-12">
      ...
      <div className="text-left text-sm">
        <div className="font-medium">{t("invoices-total")}</div>
      ...
      <div className="flex items-center justify-end">
        <a
          ...
          title="View invoice"
        >
          <p className="hidden sm:block">{t("invoices-view-invoice")}</p>
