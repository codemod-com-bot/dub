...
const { t } = useTranslation("app.dub.co/(dashboard)/[slug]/settings/library/utm");
      ...
      <div className="grid gap-4">
        ...
        {isLoading || templates?.length ? (
          ...
          <AnimatedEmptyState
            ...
            description={t('create-shared-templates-to-streamline-utm-campaign-management-across-your-team')}
            cardContent={
              <>
