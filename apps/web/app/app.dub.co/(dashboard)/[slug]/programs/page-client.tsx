    ...
    <div className="flex flex-col">
      <div className="flex-1 space-y-8">
        <div className="flex flex-col gap-4">
          ...
          <p className="rounded-md border border-neutral-200 bg-[#f9f9f9] p-4 text-sm font-normal leading-[18.20px] text-neutral-900">{t('earn-10-dollars-per-conversion')}</p>
        </div>
        ...
        <div className="flex flex-col gap-4">
          <div className="flex flex-col gap-1.5">
            ...
            <p className="text-sm font-normal leading-[21px] text-neutral-600">{t('set-partner-payout-amount')}</p>
          </div>
