...
const { t } = useTranslation("app.dub.co/(dashboard)/[slug]/programs");
        ...
        >
          <div className="scrollbar-hide flex size-full grow flex-col overflow-y-auto rounded-lg bg-white">
            <div className="flex items-center justify-between border-b border-neutral-200 px-8 py-5">
              <Drawer.Title className="text-xl font-medium text-zinc-900">{t('create-program')}</Drawer.Title>
    ...
    <div className="flex flex-col">
      <div className="flex-1 space-y-8">
        <div className="flex flex-col gap-4">
          <h3 className="text-base font-semibold leading-[17.60px] text-neutral-900">{t('summary')}</h3>
          <p className="rounded-md border border-neutral-200 bg-[#f9f9f9] p-4 text-sm font-normal leading-[18.20px] text-neutral-900">{t('earn-10-dollars-for-each-conversion')}</p>
        </div>

        <div className="flex flex-col gap-4">
          <div className="flex flex-col gap-1.5">
            <h3 className="text-base font-semibold leading-[17.60px] text-neutral-900">{t('commission')}</h3>
            <p className="text-sm font-normal leading-[21px] text-neutral-600">{t('set-partner-reward')}</p>
          </div>
        ...
        <div className="flex flex-col gap-4">
          <div className="flex flex-col gap-1.5">
            <h3 className="text-base font-semibold leading-[17.60px] text-neutral-900">{t('payout')}</h3>
            <p className="text-sm font-normal leading-[21px] text-neutral-600">{t('set-partner-payout')}</p>
          </div>
          ...
          <p className="space-y-4">
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-neutral-500">{t('minimum-payout-is-100-dollars')}</p>
            </div>
          </p>
        </div>
      </div>
