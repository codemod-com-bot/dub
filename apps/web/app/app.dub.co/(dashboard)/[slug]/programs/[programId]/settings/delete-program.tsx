  ...
  return (
    <div className="rounded-lg border border-gray-200 bg-white">
      <div className="flex flex-col gap-1 p-8">
        ...
        <p className="text-sm font-normal text-neutral-600">{t('permanently-delete-partner-program-warning')}</p>
      </div>
          ...
          <Button
            ...
            disabledTooltip={
              <div className="px-3 py-2 text-sm text-neutral-600">
                {t('contact-us-delete-program-link', { "component0": <a
                  className="underline"
                  href="mailto:support@dub.co?subject=Delete my program"
                >{t('contact-us-delete-program-link_component0')}</a> })}</div>
            }
          />
        </div>
      </div>
