              ...
              <div className="mt-2 overflow-hidden rounded-md border border-neutral-200">
                <div className="grid gap-4 p-6 pb-10">
                  ...
                  <p className="text-sm text-neutral-500">
                    {program?.name || "Dub"}
                    {t("partnership-programs-introduction")}
                  </p>
                  <Button
                    type="button"
                    ...
                    {t("email-from-system", {
                      component0: (
                        <strong className="font-medium text-neutral-900">
                          {t("email-from-system_component0")}
                        </strong>
                      ),
                    })}
                  </p>
                  <p className="text-sm text-neutral-500">
                    {t("email-subject-invitation", {
                      component0: (
                        <strong className="font-medium text-neutral-900">
                          {t("email-subject-invitation_component0")}
                        </strong>
                      ),
                    })}
                  </p>
