...
const t = useTranslations("app.dub.co/(dashboard)/[slug]/programs/[programId]/payouts");
      ...
      <div className="grid grid-cols-1 divide-neutral-200 rounded-lg border border-neutral-200 bg-neutral-50 max-sm:divide-y sm:grid-cols-2 sm:divide-x">
        <div className="flex flex-col p-4">
          <div className="flex justify-between gap-5">
            <div className="p-1">
              <div className="text-sm text-neutral-500">{t('pending-payouts')}</div>
            </div>
            <Button
              ...
              disabledTooltip={
                confirmButtonDisabled ? (
                  ...
                  <TooltipContent
                    title={t('valid-ach-bank-account-payment-method-to-send-payouts')}
          ...
          >
            {loading || eligiblePayoutsLoading ? (
              ...
              <Tooltip
                content={
                  <div className="w-64">
                    <div className="border-b border-neutral-200 p-3 text-sm font-medium text-neutral-700">{t('pending-payouts-whitespace')}</div>
        ...
        <div className="flex flex-col p-4">
          <div className="flex justify-between gap-5">
            ...
            >{t('view-invoices-whitespace')}</Link>
          </div>
