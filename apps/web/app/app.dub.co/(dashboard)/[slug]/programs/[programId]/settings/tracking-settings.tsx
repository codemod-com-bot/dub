      ...
      <div className="divide-y divide-neutral-200 px-6">
        ...
        <SettingsRow heading="Link structure">
          ...
          <div className="mt-6">
            ...
            <p className="mt-2 text-xs text-neutral-400">{t('cookie-active-days-description')}</p>
          </div>

          <div className="mt-6">
            <span className="text-sm font-medium text-neutral-800">{t('installation')}</span>
            <p className="mt-2 text-sm text-neutral-500">{t('installation-guides', { "component0": <a
              ...
              >{t('installation-guides_component0')}</a> })}
              </p>
          </div>
        </SettingsRow>
      </div>
