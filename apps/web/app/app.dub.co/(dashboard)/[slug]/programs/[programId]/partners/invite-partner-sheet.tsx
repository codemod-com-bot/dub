              ...
              <div className="mt-2 overflow-hidden rounded-md border border-neutral-200">
                <div className="grid gap-4 p-6 pb-10">
                  ...
                  <h3 className="font-medium text-gray-900">
                    {program?.name || "Dub"}
                    {t("invited-you-to-join-dub-partners")}
                  </h3>
                  <p className="text-sm text-gray-500">
                    {program?.name || "Dub"}
                    {t(
                      "uses-dub-partners-to-power-their-partnership-programs-and-wants-to-partner-with-great-people-like-yourself",
                    )}
                  </p>
                  <Button
                    type="button"
                ...
                <div className="grid gap-1 border-t border-gray-200 bg-gray-50 px-6 py-4">
                  <p className="text-sm text-gray-500">
                    {t("from-system@dub.co", {
                      component0: (
                        <strong className="font-medium text-gray-900">
                          {t("from-system@dub.co_component0")}
                        </strong>
                      ),
                    })}
                  </p>
                  <p className="text-sm text-gray-500">
                    {t("subject-youve-been-invited-to-dub-partners", {
                      component0: (
                        <strong className="font-medium text-gray-900">
                          {t(
                            "subject-youve-been-invited-to-dub-partners_component0",
                          )}
                        </strong>
                      ),
                    })}
